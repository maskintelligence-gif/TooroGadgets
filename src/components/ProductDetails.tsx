...
import { ArrowLeft, Star, ShoppingCart, ShieldCheck, Truck, RotateCcw, Download, Share2, Maximize2, X } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 lg:py-12">
        <div className="flex flex-col lg:flex-row gap-12">
          ...
          <div className="w-full lg:w-1/2">
            <div className="relative group bg-gray-50 rounded-3xl p-8 sm:p-12 flex items-center justify-center aspect-square lg:aspect-auto lg:h-[600px] overflow-hidden">
              <img
                src={product.image}
                alt={product.name}
              ...
              <button
                onClick={() => setIsPreviewOpen(true)}
                className="absolute bottom-6 right-6 p-3 bg-white/90 hover:bg-white rounded-full shadow-lg text-gray-700 opacity-0 group-hover:opacity-100 transition-opacity"
              >
                <Maximize2 size={20} />
              </button>
            </div>
          ...
          <div className="w-full lg:w-1/2">
            ...
            <div className="flex items-center gap-6 mb-8">
              ...
              <span className="text-gray-500 font-medium text-lg">{product.reviews} Verified Reviews</span>
            </div>
            ...
            <div className="mb-10">
              ...
              {product.stock && product.stock < 10 && (
                <div className="inline-flex items-center gap-2 px-3 py-1 bg-rose-50 text-rose-600 rounded-lg text-sm font-bold mt-4">
            ...
            <div className="space-y-8 mb-10">
              <div>
                <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-3 border-b border-gray-100 pb-2">Description</h3>
              ...
              {product.specs && (
                <div>
                  <h3 className="text-sm font-bold text-gray-900 uppercase tracking-wider mb-4 border-b border-gray-100 pb-2">Technical Specifications</h3>
                  <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                    {product.specs.map((spec, index) => (
                      <div key={index} className="flex items-center gap-3 text-gray-600 bg-gray-50 p-3 rounded-xl">
            ...
            <div className="grid grid-cols-3 gap-4 mb-10">
              ...
              <div className="flex flex-col items-center text-center p-4 bg-gray-50 rounded-2xl border border-gray-100">
                ...
                <span className="text-xs font-bold text-gray-900 uppercase">2yr Warranty</span>
              </div>
              <div className="flex flex-col items-center text-center p-4 bg-gray-50 rounded-2xl border border-gray-100">
                <RotateCcw className="w-8 h-8 text-blue-600 mb-2" />
                <span className="text-xs font-bold text-gray-900 uppercase">30-Day Return</span>
              </div>
            </div>

            <button
              onClick={() => onAddToCart(product)}
              className="w-full bg-gray-900 text-white py-5 rounded-2xl font-bold text-xl hover:bg-blue-600 transition-all shadow-xl hover:shadow-blue-500/20 flex items-center justify-center gap-3 active:scale-[0.98]"
            >
